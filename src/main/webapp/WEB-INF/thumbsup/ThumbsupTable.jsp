...
function pageUtil(){
	...
	function selectThumbsByKey(pageNum){
		...
		console.log(ClassId+":"+createtime);
		
		if(ClassId==""&&createtime==""){
		...
		$.ajax({
			...
			async:true,
			type:"post",
			url:"getThumbsByKey.do",
			data:{ClassId:ClassId,createTime:createtime,pageNum:pageNum},
			dataType:"json",
			success:function(json){
				...
				avag(ClassId,createtime);
				getCount(ClassId,createtime);
		...
		<div class="main-panel">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">点赞信息</a>
				</div>
								...
								<div class="content">
									<form class="form-horizontal">
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" id="ClassId"
													placeholder="请输入需要查询的学生姓名" class="form-control">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="Createtime" id="indate"
													value="<%=date%>" readonly="readonly"  required="required" class="form-control">
											</div>
...
<script type="text/javascript">
    	...
    	<script>
								...
								function  getCount(ClassId,createTime){
									...
									$.ajax({
										...
										type:"post",
										url:"getCount.do",
										data:{ClassId:ClassId,createTime:createTime},
										dataType:"json",
										success:function(json){
											//var tbody = $("#home").children().children();
											//var tbody = place;
								...
								myChart.setOption(option);
									...
									function avag(ClassId,createTime){
										$("#avag").empty();
