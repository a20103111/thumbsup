				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="card">
								<div class="header">导入学生信息Excel表格</div>
								<div class="content">
									...
									<div class="form-group">
											...
											<div class="col-md-9">
												<button type="button" class="btn btn-wd btn-success ">点击下载学生信息表格样例</button>
											</div>
										</div>
											<div class="form-group">
											<label class="col-md-3">选择需要上传的表格：</label>
											<div class="col-md-9">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<button type="button" id="import" class="btn btn-fill btn-info">点击导入表格</button>
											</div>
										</div>
									</form>
								</div>
