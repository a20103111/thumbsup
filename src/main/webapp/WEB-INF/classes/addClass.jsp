				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="card">
								<div class="header">添加班级信息</div>
								<div class="content">
									<form class="form-horizontal" action="insertClass.do"
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" name="classEndtime" id="endtime2" required="required"
