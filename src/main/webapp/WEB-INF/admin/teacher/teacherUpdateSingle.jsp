					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="card">
								...
								<div class="content">
									<form class="form-horizontal" action="updateTeacher.do"
										target="_parent" method="post">
										<div class="form-group">
											<label class="col-md-3 control-label">班主任Id</label>
											<div class="col-md-9">
												<input type="text" name="teacherId" readonly="readonly"
													value=" ${teacher.teacherId}" class="form-control">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" name="teacherName" required="required"
													value=" ${teacher.teacherName}" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">班主任手机号</label>
											<div class="col-md-9">
											<input type="text" name="teacherPhone" required="required"
													value=" ${teacher.teacherPhone}" class="form-control">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">班主任帐号</label>
											<div class="col-md-9">
											<input type="text" name="teacherAccount" required="required"
													value=" ${teacher.teacherAccount}" class="form-control">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
											<input type="password" name="teacherPassword" required="required"
													value=" ${teacher.teacherPassword}" class="form-control">
											</div>
										</div>
